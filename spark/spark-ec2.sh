./spark-ec2 --key-pair=spark-mllib --identity-file=spark-mllib.pem -s 1 --region=us-west-1 --zone=us-west-1a --instance-type=m3.large --copy-aws-credentials launch ml-cluster
